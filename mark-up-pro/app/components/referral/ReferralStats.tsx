...
const stats = [
  ...
  { label: "Active Affiliates", value: "4,000+" },
  { label: "Payout Delay", value: "0 Days" },
];
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          {stats.map((stat, i) => (
            ...
            >
              <div className="text-4xl md:text-5xl font-bold mb-2 font-orbitron text-white tracking-tighter">
                {stat.value}
              </div>
